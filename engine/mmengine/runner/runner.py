...
import engine.mmengine
from engine.mmengine.config import Config, ConfigDict
from engine.mmengine.dataset import worker_init_fn as default_worker_init_fn
from engine.mmengine.device import get_device
from engine.mmengine.dist import (broadcast, get_dist_info, get_rank, init_dist,
                           is_distributed, master_only)
from engine.mmengine.evaluator import Evaluator
from engine.mmengine.fileio import FileClient, join_path
from engine.mmengine.hooks import Hook
from engine.mmengine.logging import MessageHub, MMLogger, print_log
from engine.mmengine.model import (MMDistributedDataParallel, convert_sync_batchnorm,
                            is_model_wrapper, revert_sync_batchnorm)
from engine.mmengine.model.efficient_conv_bn_eval import \
    turn_on_efficient_conv_bn_eval
from engine.mmengine.optim import (OptimWrapper, OptimWrapperDict, _ParamScheduler,
                            build_optim_wrapper)
from engine.mmengine.registry import (DATA_SAMPLERS, DATASETS, EVALUATOR, FUNCTIONS,
                               HOOKS, LOG_PROCESSORS, LOOPS, MODEL_WRAPPERS,
                               MODELS, OPTIM_WRAPPERS, PARAM_SCHEDULERS,
                               RUNNERS, VISUALIZERS, DefaultScope)
from engine.mmengine.utils import apply_to, digit_version, get_git_hash, is_seq_of
from engine.mmengine.utils.dl_utils import (TORCH_VERSION, collect_env,
                                     set_multi_processing)
from engine.mmengine.visualization import Visualizer
...
class Runner:
    ...
    def _check_scheduler_cfg(
        ...
        Examples:
            ...
            >>> from engine.mmengine.optim import MultiStepLR
