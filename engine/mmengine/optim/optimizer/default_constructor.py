...
from engine.mmengine.registry import (OPTIM_WRAPPER_CONSTRUCTORS, OPTIM_WRAPPERS,
                               OPTIMIZERS)
from engine.mmengine.utils import is_list_of
from engine.mmengine.utils.dl_utils import mmcv_full_available
from engine.mmengine.utils.dl_utils.parrots_wrapper import _BatchNorm, _InstanceNorm
...
class DefaultOptimWrapperConstructor:
    ...
    def add_params(self,
        ...
        if mmcv_full_available():
            from cv.mmcv.ops import DeformConv2d, ModulatedDeformConv2d
