...
from engine.mmengine.device import (is_cuda_available, is_mlu_available,
                             is_npu_available)
from engine.mmengine.registry import OPTIM_WRAPPERS
...
class AmpOptimWrapper(OptimWrapper):
    ...
    def optim_context(self, model: nn.Module):
        ...
        """
        from engine.mmengine.runner.amp import autocast
