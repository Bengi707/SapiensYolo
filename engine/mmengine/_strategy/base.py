...
from engine.mmengine.dist import (broadcast, get_dist_info, infer_launcher,
                           is_distributed)
from engine.mmengine.logging import MMLogger
from engine.mmengine.model.wrappers import is_model_wrapper
from engine.mmengine.optim import (BaseOptimWrapper, OptimWrapperDict,
                            _ParamScheduler, build_optim_wrapper)
from engine.mmengine.registry import MODELS, OPTIM_WRAPPERS, PARAM_SCHEDULERS
...
class BaseStrategy(metaclass=ABCMeta):
    ...
    def _set_randomness(
        ...
        Args:
            ...
            deterministic (bool): Whether to set the deterministic option for
                ...
                more details.
        """
        from engine.mmengine.runner import set_random_seed
    ...
    def model_state_dict(self) -> dict:
        ...
        from engine.mmengine.runner import weights_to_cpu
    ...
    def load_model_state_dict(
        ...
        *,
        ...
        from engine.mmengine.runner.checkpoint import _load_checkpoint_to_model
    ...
    def load_or_resume(
        ...
        *,
        ...
        """
        from engine.mmengine.runner import find_latest_checkpoint
