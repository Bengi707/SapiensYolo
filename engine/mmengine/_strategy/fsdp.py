...
from engine.mmengine.dist import get_rank, is_main_process
from engine.mmengine.model import BaseDataPreprocessor, is_model_wrapper
from engine.mmengine.optim import (AmpOptimWrapper, BaseOptimWrapper, OptimWrapper,
                            OptimWrapperDict, _ParamScheduler,
                            build_optim_wrapper)
from engine.mmengine.registry import (MODEL_WRAPPERS, OPTIM_WRAPPERS,
                               PARAM_SCHEDULERS, STRATEGIES, Registry)
from engine.mmengine.utils import get_git_hash, mkdir_or_exist
...
def _save_checkpoint(params):
    from engine.mmengine.runner.checkpoint import save_checkpoint
