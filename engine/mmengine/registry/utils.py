...
def count_registered_modules(save_path: Optional[str] = None,
    ...
    import engine.mmengine.dataset
    import engine.mmengine.evaluator
    import engine.mmengine.hooks
    import engine.mmengine.model
    import engine.mmengine.optim
    import engine.mmengine.runner
    import engine.mmengine.visualization  # noqa: F401
