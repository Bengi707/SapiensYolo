...
from engine.mmengine.dist import is_main_process, master_only
from engine.mmengine.fileio import FileClient, get_file_backend
from engine.mmengine.logging import print_log
from engine.mmengine.registry import HOOKS
from engine.mmengine.utils import is_list_of, is_seq_of
...
class CheckpointHook(Hook):
    ...
    def _publish_model(self, runner, ckpt_path: str) -> None:
        ...
        """
        from engine.mmengine.runner import save_checkpoint
