...
from ultralytics.ultralytics.utils.metrics import OKS_SIGMA, PoseMetrics, box_iou, kpt_iou
...
class PoseValidator(DetectionValidator):
    ...
    Example:
        ```python
        from ultralytics.ultralytics.models.yolo.pose import PoseValidator
