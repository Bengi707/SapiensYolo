...
from ultralytics.ultralytics.data.utils import polygons2masks, polygons2masks_overlap
from ultralytics.ultralytics.utils import LOGGER, colorstr
from ultralytics.ultralytics.utils.checks import check_version
from ultralytics.ultralytics.utils.instance import Instances
from ultralytics.ultralytics.utils.metrics import bbox_ioa
from ultralytics.ultralytics.utils.ops import segment2box, xyxyxyxy2xywhr
from ultralytics.ultralytics.utils.torch_utils import TORCHVISION_0_10, TORCHVISION_0_11, TORCHVISION_0_13
...
class Compose:
    ...
    def __init__(self, transforms):
        ...
        Examples:
            >>> from ultralytics.ultralytics.data.augment import Compose, RandomHSV, RandomFlip
...
class Mosaic(BaseMixTransform):
    ...
    Examples:
        >>> from ultralytics.ultralytics.data.augment import Mosaic
...
class MixUp(BaseMixTransform):
    ...
    Examples:
        >>> from ultralytics.ultralytics.data.augment import MixUp
        >>> dataset = YourDataset(...)  # Your image dataset
...
class RandomHSV:
    ...
    Examples:
        >>> import numpy as np
        >>> from ultralytics.ultralytics.data.augment import RandomHSV
...
class CopyPaste(BaseMixTransform):
    ...
    Examples:
        >>> from ultralytics.ultralytics.data.augment import CopyPaste
        >>> dataset = YourDataset(...)  # Your image dataset
...
def v8_transforms(dataset, imgsz, hyp, stretch=False):
    ...
    Examples:
        >>> from ultralytics.ultralytics.data.dataset import YOLODataset
        >>> from ultralytics.ultralytics.utils import IterableSimpleNamespace
