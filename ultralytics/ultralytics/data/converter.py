...
from ultralytics.ultralytics.utils import DATASETS_DIR, LOGGER, NUM_THREADS, TQDM
...
def convert_dota_to_yolo_obb(dota_root_path: str):
    ...
    Example:
        ```python
        from ultralytics.ultralytics.data.converter import convert_dota_to_yolo_obb
...
def yolo_bbox2segment(im_dir, save_dir=None, sam_model="sam_b.pt", device=None):
    ...
    from ultralytics.ultralytics.utils import LOGGER
...
def create_synthetic_coco_dataset():
    ...
    Examples:
        >>> from ultralytics.ultralytics.data.converter import create_synthetic_coco_dataset
