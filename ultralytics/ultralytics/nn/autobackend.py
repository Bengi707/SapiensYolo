...
from ultralytics.ultralytics.utils import ARM64, IS_JETSON, IS_RASPBERRYPI, LINUX, LOGGER, ROOT, yaml_load
from ultralytics.ultralytics.utils.checks import check_requirements, check_suffix, check_version, check_yaml
from ultralytics.ultralytics.utils.downloads import attempt_download_asset, is_url
...
class AutoBackend(nn.Module):
    ...
    def __init__(
        ...
        # TF GraphDef
            ...
            from ultralytics.ultralytics.engine.exporter import gd_outputs
        ...
        # NVIDIA Triton Inference Server
            ...
            from ultralytics.ultralytics.utils.triton import TritonRemoteModel
    ...
    def forward(self, im, augment=False, visualize=False, embed=None):
        ...
        # CoreML
            ...
            if "confidence" in y:
                ...
                # from ultralytics.ultralytics.utils.ops import xywh2xyxy
