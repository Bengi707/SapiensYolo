...
from ultralytics.ultralytics.cfg import TASK2DATA, get_cfg
from ultralytics.ultralytics.data import build_dataloader
from ultralytics.ultralytics.data.dataset import YOLODataset
from ultralytics.ultralytics.data.utils import check_cls_dataset, check_det_dataset
from ultralytics.ultralytics.nn.autobackend import check_class_names, default_class_names
from ultralytics.ultralytics.nn.modules import C2f, Detect, RTDETRDecoder
from ultralytics.ultralytics.nn.tasks import DetectionModel, SegmentationModel, WorldModel
...
from ultralytics.ultralytics.utils.checks import check_imgsz, check_is_path_safe, check_requirements, check_version
from ultralytics.ultralytics.utils.downloads import attempt_download_asset, get_github_assets, safe_download
from ultralytics.ultralytics.utils.files import file_size, spaces_in_path
from ultralytics.ultralytics.utils.ops import Profile
from ultralytics.ultralytics.utils.torch_utils import TORCH_1_13, get_latest_opset, select_device
...
class Exporter:
    ...
    def __call__(self, model=None) -> str:
        ...
        if imx:
            from ultralytics.ultralytics.utils.torch_utils import FXModel
        ...
        for m in model.modules():
            ...
            if isinstance(m, Detect) and imx:
                from ultralytics.ultralytics.utils.tal import make_anchors
