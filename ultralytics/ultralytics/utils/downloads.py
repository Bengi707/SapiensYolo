...
from ultralytics.ultralytics.utils import LOGGER, TQDM, checks, clean_url, emojis, is_online, url2file
...
def delete_dsstore(path, files_to_delete=(".DS_Store", "__MACOSX")):
    ...
    Example:
        ```python
        from ultralytics.ultralytics.utils.downloads import delete_dsstore
...
def unzip_file(file, path=None, exclude=(".DS_Store", "__MACOSX"), exist_ok=False, progress=True):
    ...
    Example:
        ```python
        from ultralytics.ultralytics.utils.downloads import unzip_file
...
def attempt_download_asset(file, repo="ultralytics/assets", release="v8.3.0", **kwargs):
    ...
    Example:
        ...
        ```
    """
    from ultralytics.ultralytics.utils import SETTINGS  # scoped for circular import
