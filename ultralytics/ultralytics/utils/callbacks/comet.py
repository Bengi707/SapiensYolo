...
from ultralytics.ultralytics.utils import LOGGER, RANK, SETTINGS, TESTS_RUNNING, ops
from ultralytics.ultralytics.utils.metrics import ClassifyMetrics, DetMetrics, OBBMetrics, PoseMetrics, SegmentMetrics
...
def on_fit_epoch_end(trainer):
    ...
    if curr_epoch == 1:
        from ultralytics.ultralytics.utils.torch_utils import model_info_for_loggers
