...
from ultralytics.ultralytics.utils import LOGGER, SETTINGS, TESTS_RUNNING, colorstr
...
try:
    ...
    from ultralytics.ultralytics.utils.torch_utils import de_parallel, torch
