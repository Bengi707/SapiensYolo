...
def parse_requirements(file_path=ROOT.parent / "requirements.txt", package=""):
    ...
    Example:
        ```python
        from ultralytics.ultralytics.utils.checks import parse_requirements
...
def collect_system_info():
    ...
    from ultralytics.ultralytics.utils import ENVIRONMENT  # scope to avoid circular import
    from ultralytics.ultralytics.utils.torch_utils import get_cpu_info, get_gpu_info
...
def check_amp(model):
    ...
    """
    from ultralytics.ultralytics.utils.torch_utils import autocast
