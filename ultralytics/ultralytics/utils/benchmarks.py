...
Usage:
    from ultralytics.ultralytics.utils.benchmarks import ProfileModels, benchmark
...
from ultralytics.ultralytics.cfg import TASK2DATA, TASK2METRIC
from ultralytics.ultralytics.engine.exporter import export_formats
from ultralytics.ultralytics.utils import ARM64, ASSETS, IS_JETSON, IS_RASPBERRYPI, LINUX, LOGGER, MACOS, TQDM, WEIGHTS_DIR
from ultralytics.ultralytics.utils.checks import IS_PYTHON_3_12, check_requirements, check_yolo
from ultralytics.ultralytics.utils.downloads import safe_download
from ultralytics.ultralytics.utils.files import file_size
from ultralytics.ultralytics.utils.torch_utils import get_cpu_info, select_device
...
def benchmark(
    ...
    Examples:
        ...
        >>> from ultralytics.ultralytics.utils.benchmarks import benchmark
