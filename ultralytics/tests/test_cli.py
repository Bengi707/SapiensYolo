...
from ultralytics.tests import CUDA_DEVICE_COUNT, CUDA_IS_AVAILABLE
from ultralytics.ultralytics.cfg import TASK2DATA, TASK2MODEL, TASKS
from ultralytics.ultralytics.utils import ASSETS, WEIGHTS_DIR, checks
...
def test_fastsam(task="segment", model=WEIGHTS_DIR / "FastSAM-s.pt", data="coco8-seg.yaml"):
    ...
    from ultralytics.ultralytics.models.sam import Predictor
