...
from ultralytics.tests import CFG, MODEL, SOURCE, SOURCES_LIST, TMP
from ultralytics.ultralytics import RTDETR, YOLO
from ultralytics.ultralytics.cfg import MODELS, TASK2DATA, TASKS
from ultralytics.ultralytics.data.build import load_inference_source
...
from ultralytics.ultralytics.utils.downloads import download
from ultralytics.ultralytics.utils.torch_utils import TORCH_1_9
...
def test_data_utils():
    ...
    from ultralytics.ultralytics.data.utils import HUBDatasetStats, autosplit
    from ultralytics.ultralytics.utils.downloads import zip_directory

    # from ultralytics.ultralytics.utils.files import WorkingDirectory
...
def test_data_converter():
    ...
    from ultralytics.ultralytics.data.converter import coco80_to_coco91_class, convert_coco
...
def test_data_annotator():
    ...
    from ultralytics.ultralytics.data.annotator import auto_annotate
...
def test_events():
    ...
    from ultralytics.ultralytics.hub.utils import Events
...
def test_cfg_init():
    ...
    from ultralytics.ultralytics.cfg import check_dict_alignment, copy_default_cfg, smart_value
...
def test_utils_init():
    ...
    from ultralytics.ultralytics.utils import get_git_branch, get_git_origin_url, get_ubuntu_version, is_github_action_running
...
def test_utils_benchmarks():
    ...
    from ultralytics.ultralytics.utils.benchmarks import ProfileModels
...
def test_utils_torchutils():
    ...
    from ultralytics.ultralytics.nn.modules.conv import Conv
    from ultralytics.ultralytics.utils.torch_utils import get_flops_with_torch_profiler, profile, time_sync
...
def test_utils_downloads():
    """Test file download utilities from ultralytics.ultralytics.utils.downloads."""
    from ultralytics.ultralytics.utils.downloads import get_google_drive_file_info
...
def test_utils_files():
    ...
    from ultralytics.ultralytics.utils.files import file_age, file_date, get_latest_run, spaces_in_path
...
def test_utils_patches_torch_save():
    ...
    from ultralytics.ultralytics.utils.patches import torch_save
...
def test_nn_modules_conv():
    ...
    from ultralytics.ultralytics.nn.modules.conv import CBAM, Conv2, ConvTranspose, DWConvTranspose2d, Focus
...
def test_nn_modules_block():
    ...
    from ultralytics.ultralytics.nn.modules.block import C1, C3TR, BottleneckCSP, C3Ghost, C3x
...
def test_hub():
    ...
    from ultralytics.ultralytics.hub import export_fmts_hub, logout
    from ultralytics.ultralytics.hub.utils import smart_request
...
def test_classify_transforms_train(image, auto_augment, erasing, force_color_jitter):
    ...
    from ultralytics.ultralytics.data.augment import classify_augmentations
...
def test_yolo_world():
    ...
    from ultralytics.ultralytics.models.yolo.world.train_world import WorldTrainerFromScratch
