...
from ultralytics.tests import TMP
...
def pytest_sessionstart(session):
    ...
    Returns:
        (None)
    """
    from ultralytics.ultralytics.utils.torch_utils import init_seeds
...
def pytest_terminal_summary(terminalreporter, exitstatus, config):
    ...
    Returns:
        (None)
    """
    from ultralytics.ultralytics.utils import WEIGHTS_DIR
