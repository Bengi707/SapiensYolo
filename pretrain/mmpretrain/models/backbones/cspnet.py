...
from cv.mmcv.cnn import ConvModule, DepthwiseSeparableConvModule
from cv.mmcv.cnn.bricks import DropPath
from engine.mmengine.model import BaseModule, Sequential
from torch.nn.modules.batchnorm import _BatchNorm

from pretrain.mmpretrain.registry import MODELS
...
class CSPNet(BaseModule):
    ...
    Example:
        ...
        >>> import torch
        >>> import torch.nn as nn
        >>> from pretrain.mmpretrain.models import CSPNet
        >>> from pretrain.mmpretrain.models.backbones.resnet import Bottleneck
        >>>
...
class CSPDarkNet(CSPNet):
    ...
    Example:
        >>> from pretrain.mmpretrain.models import CSPDarkNet
        >>> import torch
...
class CSPResNet(CSPNet):
    ...
    Args:
        ...
        init_cfg (dict or list[dict], optional): Initialization config dict.
            Default: None.
    Example:
        >>> from pretrain.mmpretrain.models import CSPResNet
        >>> import torch
...
class CSPResNeXt(CSPResNet):
    ...
    Args:
        ...
        init_cfg (dict or list[dict], optional): Initialization config dict.
            Default: None.
    Example:
        >>> from pretrain.mmpretrain.models import CSPResNeXt
        >>> import torch
