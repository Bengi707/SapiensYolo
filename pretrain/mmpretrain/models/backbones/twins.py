...
from cv.mmcv.cnn import Conv2d, build_norm_layer
from cv.mmcv.cnn.bricks.drop import build_dropout
from cv.mmcv.cnn.bricks.transformer import FFN, PatchEmbed
from engine.mmengine.model import BaseModule, ModuleList
from engine.mmengine.model.weight_init import (constant_init, normal_init,
                                        trunc_normal_init)
...
class PCPVT(BaseModule):
    ...
    Examples:
        >>> from pretrain.mmpretrain.models import PCPVT
        >>> import torch
...
class SVT(PCPVT):
    ...
    Examples:
        >>> from pretrain.mmpretrain.models import SVT
        >>> import torch
        >>> svt_cfg = {'arch': "small",
        >>>            'norm_after_stage': [False, False, False, True]}
        >>> model = SVT(**svt_cfg)
