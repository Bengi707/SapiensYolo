...
from cv.mmcv.cnn import build_norm_layer
from cv.mmcv.cnn.bricks.transformer import FFN, PatchEmbed, PatchMerging
...
class SwinTransformer(BaseBackbone):
    ...
    Examples:
        >>> from pretrain.mmpretrain.models import SwinTransformer
        >>> import torch
        >>> extra_config = dict(
        >>>     arch='tiny',
