...
from engine.mmengine.optim import CosineAnnealingLR, LinearLR, OptimWrapper
from engine.mmengine.runner import EpochBasedTrainLoop
from torch.optim import AdamW

from pretrain.mmpretrain.models import (EVA, CLIPGenerator, CosineSimilarityLoss,
