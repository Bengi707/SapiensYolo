...
from engine.mmengine.dataset import DefaultSampler, default_collate
from engine.mmengine.hooks import CheckpointHook
from engine.mmengine.model import ConstantInit, PretrainedInit, TruncNormalInit
from engine.mmengine.optim import AmpOptimWrapper, CosineAnnealingLR, LinearLR
from engine.mmengine.runner import EpochBasedTrainLoop
from torch.optim import AdamW

from pretrain.mmpretrain.datasets import (BEiTMaskGenerator, ColorJitter, ImageNet,
                                 LoadImageFromFile, PackInputs, RandomFlip,
                                 RandomResizedCropAndInterpolationWithTwoPic)
from pretrain.mmpretrain.models import (BEiT, BEiTPretrainViT, BEiTV1Head,
