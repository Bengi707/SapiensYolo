...
from pretrain.mmpretrain.registry import METRICS
from pretrain.mmpretrain.structures import label_to_onehot
...
class MultiLabelMetric(BaseMetric):
    ...
    **Support** is the number of samples:
    ...
    Examples:
        >>> import torch
        >>> from pretrain.mmpretrain.evaluation import MultiLabelMetric
...
class AveragePrecision(BaseMetric):
    ...
    Examples:
        >>> import torch
        >>> from pretrain.mmpretrain.evaluation import AveragePrecision
        >>> # --------- The Basic Usage for one-hot pred scores ---------
