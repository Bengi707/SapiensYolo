...
def get_model(model: Union[str, Config],
    ...
    Examples:
        ...
        >>> import torch
        >>> from pretrain.mmpretrain import get_model
        ...
        >>> from pretrain.mmpretrain import get_model, inference_model
    ...
    from engine.mmengine.registry import DefaultScope
    ...
    if pretrained:
        ...
        from engine.mmengine.runner import load_checkpoint
...
def list_models(pattern=None, exclude_patterns=None, task=None) -> List[str]:
    ...
    Examples:
        ...
        >>> from pretrain.mmpretrain import list_models
        >>> list_models()
