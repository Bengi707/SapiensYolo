...
import numpy as np
import torch
from cv.mmcv.image import imread
from engine.mmengine.config import Config
from engine.mmengine.dataset import BaseDataset, Compose, default_collate

from pretrain.mmpretrain.registry import TRANSFORMS
from pretrain.mmpretrain.structures import DataSample
from pretrain.mmpretrain.utils import track
...
class TextToImageRetrievalInferencer(BaseInferencer):
    ...
    Example:
        >>> from pretrain.mmpretrain import TextToImageRetrievalInferencer
    ...
    def _prepare_prototype(self, prototype, cache=None, batch_size=8):
        ...
        if isinstance(prototype, list):
            ...
            # A config of dataset
            from pretrain.mmpretrain.registry import DATASETS
            test_pipeline = [dict(type='LoadImageFromFile'), self.img_pipeline]
    ...
    def visualize(self,
        ...
        if self.visualizer is None:
            from pretrain.mmpretrain.visualization import UniversalVisualizer
...
class ImageToTextRetrievalInferencer(BaseInferencer):
    ...
    Example:
        >>> from pretrain.mmpretrain import ImageToTextRetrievalInferencer
