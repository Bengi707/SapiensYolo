...
from pretrain.mmpretrain import FeatureExtractor
import os
import time
...
def main():
    ...
    parser.add_argument('--config', default =r"C:\Users\Bengi\PycharmProjects\sapiens\pretrain\configs\_base_\models\vit-base-p16.py", help='Config file for pose')
    parser.add_argument('--checkpoint', default = r"C:\Users\Bengi\Downloads\sapiens_0.3b_epoch_1600_clean.pth", help='Checkpoint file for pose')
    parser.add_argument(
        '--input', type=str, default=r"C:\Users\Bengi\Downloads\pose.jpg", help='Image/Video file')
    parser.add_argument(
        '--output-root',
        type=str,
        default='./',
